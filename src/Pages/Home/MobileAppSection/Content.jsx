    ...
    <div className="py-18 lg:py-40 container2 overflow-hidden">
      <div className="flex flex-col lg:flex-row items-center gap-12 lg:w-8/10 lg:mx-auto">
        <div className="w-4/7 lg:2/7">
          <img
            className="w-[320px] animation-bottom"
            src="/assets/bg_image/app.png"
          />
        </div>
        <div className="w-full lg:w-5/7">
          <h1 className="animation-bottom hidden lg:block text-2xl lg:text-4xl font-bold">
            Our Mobile App
          </h1>
          <div className="animation-bottom flex justify-between gap-1.5 lg:gap-4 bg-[linear-gradient(149deg,_#DC02CE_0%,_#7C3FF2_70.83%,_#5C53FE_100%)] px-3 py-2.5 lg:p-7 rounded-xl text-center font-grotesk mt-7 mb-5">
            <div className="border-r border-gray-400 p-2 lg:p-4 flex-1">
          ...
          <p className="animation-bottom text-center lg:text-left mb-8 font-semibold">
            Learn programming the fun way with the Programming Hero app!
            Download now on the App Store or Google Play.
          </p>
          <div className="animation-bottom flex gap-3.5 md:gap-5">
            <img
